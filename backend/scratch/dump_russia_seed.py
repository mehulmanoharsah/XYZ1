...
def main():
    ...
    institutions = list(db.institutions.find({"country": "Russia"}))
    print(f"Found {len(institutions)} Russia institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// RUSSIA UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 19 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions russia_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing Russia data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"Russia\" });")
    ...
    js_content.append("print(\"Russia Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/russia_universities_seed.js"
