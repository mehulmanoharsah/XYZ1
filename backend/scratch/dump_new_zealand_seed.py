...
def main():
    ...
    institutions = list(db.institutions.find({"country": "New Zealand"}))
    print(f"Found {len(institutions)} New Zealand institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// NEW ZEALAND UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 19 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions new_zealand_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing New Zealand data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"New Zealand\" });")
    ...
    js_content.append("print(\"New Zealand Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/new_zealand_universities_seed.js"
