...
def main():
    ...
    institutions = list(db.institutions.find({"country": "South Korea"}))
    print(f"Found {len(institutions)} South Korea institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// SOUTH KOREA UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 20 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions south_korea_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("  if (!programs || programs.length === 0) return;")
    ...
    js_content.append("// Delete existing South Korea data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"South Korea\" });")
    ...
    js_content.append("print(\"South Korea Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/south_korea_universities_seed.js"
