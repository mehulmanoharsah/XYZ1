...
def main():
    ...
    institutions = list(db.institutions.find({"country": "Ireland"}))
    print(f"Found {len(institutions)} Ireland institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// IRELAND UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 19 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions ireland_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing Ireland data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"Ireland\" });")
    ...
    js_content.append("print(\"Ireland Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/ireland_universities_seed.js"
