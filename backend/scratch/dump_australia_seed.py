...
def main():
    ...
    institutions = list(db.institutions.find({"country": "Australia"}))
    print(f"Found {len(institutions)} Australia institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// AUSTRALIA UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 20 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions australia_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing Australia data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"Australia\" });")
    ...
    js_content.append("print(\"Australia Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/australia_universities_seed.js"
