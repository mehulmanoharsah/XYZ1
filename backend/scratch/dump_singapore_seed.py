...
def main():
    ...
    institutions = list(db.institutions.find({"country": "Singapore"}))
    print(f"Found {len(institutions)} Singapore institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// SINGAPORE UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 21 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions singapore_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing Singapore data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"Singapore\" });")
    ...
    js_content.append("print(\"Singapore Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/singapore_universities_seed.js"
