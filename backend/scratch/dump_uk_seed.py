...
def main():
    ...
    institutions = list(db.institutions.find({"country": "UK"}))
    print(f"Found {len(institutions)} UK institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// UK UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 20 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions uk_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing UK data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"UK\" });")
    ...
    js_content.append("print(\"UK Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/uk_universities_seed.js"
