...
def main():
    ...
    institutions = list(db.institutions.find({"country": "Netherlands"}))
    print(f"Found {len(institutions)} Netherlands institutions to dump.")
    
    js_content = []
    js_content.append("// ============================================================")
    js_content.append("// NETHERLANDS UNIVERSITIES & COLLEGES — MONGODB SEED SCRIPT")
    js_content.append("// 20 Institutions | UG & PG Programs | 2025-26")
    js_content.append("// ============================================================")
    js_content.append("// Usage: mongosh canadian_institutions netherlands_universities_seed.js")
    js_content.append("// ============================================================\n")
    ...
    js_content.append("// Delete existing Netherlands data to prevent duplicates")
    js_content.append("db.institutions.deleteMany({ country: \"Netherlands\" });")
    ...
    js_content.append("print(\"Netherlands Seeding Completed!\");")
    
    output_path = "/Users/mehulmanoharsah/Downloads/university-portal 3/netherlands_universities_seed.js"
