...
export default function AccommodationDetailPage() {
  ...
  const accommodationSchema = accommodation ? {
    ...
    "image": accommodation.images?.map(img => img.startsWith('http') ? img : `${window.location.origin}${img}`) || [],
    "offers": {
      "@type": "Offer",
      "price": accommodation.price_per_month_cad,
      "priceCurrency": "CAD",
      "priceSpecification": {
    ...
    "aggregateRating": accommodation.rating ? {
      ...
      "reviewCount": accommodation.reviews_count || 1
    } : undefined
  } : null

  useStructuredData(accommodationSchema)
