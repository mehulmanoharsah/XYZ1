...
export default function AccommodationPage() {
  ...
  const accommodationsSchema = accommodations && accommodations.length > 0 ? {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Student Accommodations | Wellyura",
    "description": "Explore international student accommodations, hostels, and residences near your university.",
    "itemListElement": accommodations.map((acc, idx) => ({
      "@type": "ListItem",
      "position": idx + 1,
      "url": `${window.location.origin}/accommodations/${acc.slug}`,
      "name": acc.name
    }))
  } : null

  useStructuredData(accommodationsSchema)
